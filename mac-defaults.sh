...
# sudo scutil --set ComputerName "macinator"
# sudo scutil --set HostName "macinator"
...
sudo defaults write com.apple.BluetoothAudioAgent "Apple Bitpool Max (editable)" -int 64
